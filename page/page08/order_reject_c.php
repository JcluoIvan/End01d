<?php
    ...
    $reject['dateRecord'] = $rejectData->odr012 ? $rejectData->odr012->format('Y-m-d') : '';
    $reject['checkDate'] = $rejectData->odr016 ? $rejectData->odr016->format('Y-m-d') : '';
    $reject['rejectdate'] = $rejectData->odr017 ? $rejectData->odr017->format('Y-m-d') : '';
    ...
    $tpl->display('page08_order_reject_c.tpl');
