...
<div class="col-xs-12">
    ...
    <form id="option-form" acrion="?" class="rejectC form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <input type="text" name="rNO" id="rNO" class="form-control" value="{{$reject['rNO']}}" readonly />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <input name="amount" id="amount" type="number" class="form-control" value="{{$reject['amount']}}" />
            </div>

            <label class="control-label col-xs-2"> 退貨總金額 </label>
            <div class="col-xs-2">
                <input type="text" name="rTmoney" id="rTmoney" class="form-control" value="{{$reject['rTmoney']}}" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <input name="rTpoint" id="rTpoint" type="text" class="form-control" value="{{$reject['rTpoint']}}" />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                <div class="input-group">
                    <input class="form-control" name="rejectdate" type="text" id="rejectdate" onpropertychange="zzday();" value="{{$rRecord}}" />
