<?php /* Smarty version Smarty-3.1.8, created on 2015-10-16 16:27:51
         compiled from "/home/www//theme/default/page03_order_status_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8432519745620b5070ef946-98971270%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1081aa5b6fa88b56a4fa671ac1afa65907dacc3f' => 
    array (
      0 => '/home/www//theme/default/page03_order_status_list.tpl',
      1 => 1443171017,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8432519745620b5070ef946-98971270',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5620b50713c745_49826863',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5620b50713c745_49826863')) {function content_5620b50713c745_49826863($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<body>
    <div class="col-xs-12">
        <ol class="breadcrumb">
            <li><a class="active">出貨狀態查詢</a></li>
        </ol>
        <h3 class="title-bar">
            <!-- <div id="option-bar" class="pull-right"></div> -->
            <label>訂單管理 - 出貨狀態查詢</label>
        </h3>
        <div style="display:inline-block; width: 100%">
            <div class="pull-left" >
                <form id="command-search" class="form-inline">
                    <label for="exampleInputName2">搜尋</label>
                    <input name="no" id="no" type="text" size="22px" class="form-control" placeholder="訂單編號;取貨序號;手機號碼" />
                    <input name="shipmentno" id="shipmentno" type="hidden" value="1" />
    ...
    <script type="text/javascript" src="/js/page03_order_status_list.js?<?php echo time();?>
"></script>
