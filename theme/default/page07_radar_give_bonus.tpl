...
<body>
    ...
    <script type="text/javascript" src="/js/page07_radar_give_bonus.js?{{$smarty.now}}"></script>
    <script type="text/javascript" src="/js/page07_radar_bonus_detail_list.js?{{$smarty.now}}"></script>
    <script>
        fastdata(5);
