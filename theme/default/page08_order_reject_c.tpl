    ...
    <form id="option-form" acrion="?" class="rejectC form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                ...
                {{if $reject['status'] > 0}}
                    <input class="form-control" type="text" value="{{$reject['rejectdate']}}" readonly />
                {{else}}
                    <div class="input-group">
                        <input class="form-control" name="rejectdate" type="text" id="rejectdate" onpropertychange="zzday();" value="{{$reject['rejectdate']}}" />
