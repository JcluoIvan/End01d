<div class="col-xs-12">
    ...
    <form id="option-form" acrion="?" class="swapC form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
                {{if $swap['status'] > 0}}
                    <input class="form-control" type="text" value="{{$swap['swapdate']}}" readonly />
                {{else}}
                    <div class="input-group">
                        <input class="form-control" name="swapdate" type="text" id="swapdate" onpropertychange="zzday();" value="{{$swap['swapdate']}}" />
