...
class RejectDetail extends BaseModel
{
    // explicit table name since our table is not "books"
    static $table_name = 'order_reject_detail';

    // explicit pk since our pk is not "id"
    static $primary_key = 'ord001';
    ...
    static $has_to = array(
        'product' => array('Product', 'pdm001', 'ord003', 'single'),
    );
    ...
    public static function getRejectDetail($oid) {
        $sql = 'SELECT ord001 AS sn, '
            . '     ord002 AS oid, '
            . '     ord003 AS pid, '
            . '     ord004 AS productName, '
