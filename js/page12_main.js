(function(Endold, OptionBar) {
    ...
    var Reject_LIST_URL = '/page/page12/reject_list.php';
    var Swap_LIST_URL = '/page/page12/swap_list.php'; 
    var $searchForm = null;
    ...
    var app = {
        ...
        onclickPrint: function() {
            ...
            var date1 = $('#date1').val();
            var date2 = $('#date2').val();
            var url = Endold.linkTo('/page/page12/order_print.php', {
                no: no,
                date1: date1,
                date2: date2
            });
    ...
    var option = new OptionBar({
        ...
        onSave: function() {
            ...
            if ($this.hasClass('reject')) {
                ...
                $form.attr('action', Endold.cmdTo(1208));
                $form.trigger('submit');
                return false;
            }
            // var $form = $('#option-form');
            // $form.attr('action', Endold.cmdTo(1217));
            // $form.trigger('submit');
        },
        onShow: function() {
            modify.init();
        ...
        colModel: [ 
            {
               ...
               align: 'center'
                ...
                process: function(div, sn) {
                    ...
                    var date1 = $('#date1').val();
                    var date2 = $('#date2').val();
                    var m_url = Endold.linkTo('page/page12/order_modify.php', {sn: sn});
                    var d_url = Endold.linkTo('page/page12/order_detail.php', {sn: sn});
    ...
    var modify = {
        ...
        removeReceipt: function() {
            ...
            // Endold.post(1217, {id: id, files: $files})
