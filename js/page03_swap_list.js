(function(Endold, OptionBar) {
    ...
    var MODIFY_URL = '/page/page03/order_swap_c.php';
    ...
    var app = {
        ...
        onclickPrint: function() {
            ...
            var date1 = $('#date1').val();
            var date2 = $('#date2').val();
            var url = Endold.linkTo('/page/page03/swap_list_print.php', {
                oid: oid,
                no: no,
                date1: date1,
                date2: date2
    ...
    var option = new OptionBar({
        ...
        onModify: function() {
            oid = $('#oid').val();
            console.log(this);
            return $(this).attr('href') || Endold.linkTo('/page/page03/order_swap.php', {oid: oid});
                ...
                process: function(div, sn) {
                    ...
                    if(statusCheck == '核帳' || statusCheck == '註銷') {
                        ...
                        var $a = $('<a/>')
                            ...
                            .attr({
                                href: Endold.linkTo('page/page03/order_swap_c.php', {sn: sn}) 
                            });
