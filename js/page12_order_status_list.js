(function(Endold, OptionBar) {
    ...
    var app = {
        ...
        onclickPrint: function() {
            ...
            var date1 = $('#date1').val();
            var date2 = $('#date2').val();
            var url = Endold.linkTo('/page/page12/order_status_list_print.php', {
                no: no,
                date1: date1,
                date2: date2
            });
    ...
    var grid = $('#order-list').flexigrid({
        ...
        //     }, 
            ...
            //    align: 'center'
               ...
               align: 'center'
                ...
                process: function(div, sn) {
                    var url = Endold.linkTo('page/page12/order_detail', {sn: sn});
                    var $a = $('<a/>')
                        .html('明細')
                        .bind('click', option.view)
                        .attr({href: Endold.linkTo('page/page12/order_detail.php', {sn: sn}) 
                        });
            ...
            //         var url = Endold.linkTo('page/page12/order_swap.php', {oid: oid });
            ...
            //     align: 'center',
            //     process: function(div, oid) {
            //         var url = Endold.linkTo('page/page12/order_reject.php', {oid: oid });
            //         var has = Number(div.innerHTML) !== 0;
            //         var $a = $('<a/>').html('退貨')
            ...
            //     align: 'center',
            //     process: function(div, oid) {
            //         var url = Endold.linkTo('page/page12/order_status.php', {oid: oid});
            //         var $a = $('<a/>')
            //             .html('edit')
            //             .bind('click', option.modify)
            //             .attr({href: Endold.linkTo('page/page12/order_status.php', {oid: oid}) 
            //             });
