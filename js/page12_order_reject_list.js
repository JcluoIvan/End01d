(function(Endold, OptionBar) {
    ...
    var app = {
        ...
        onclickPrint: function() {
            ...
            $print.attr('action', Endold.linkTo('/page/page12/order_reject_list_print.php'));
            $print.trigger('submit');

            // var no = $('#no').val();
            // var date1 = $('#date1').val();
            // var date2 = $('#date2').val();
            // var url = Endold.linkTo('/page/page12/order_reject_list_print.php', {
            //     no: no,
            //     date1: date1,
            //     date2: date2
            // });
        ...
        oncancelRadar: function() {
            ...
            if(confirm("確定是否取消退貨？")){
                Endold
                    .post(1221, {checkData:app.rows,date1:date1,date2:date2})
        ...
        oncheckRadar: function() {
            ...
            if(confirm("確定是否核帳？")){
                Endold
                    .post(1218, {checkData:app.rows,date1:date1,date2:date2})
                    .done(app.requestRadar);
            }
        },
