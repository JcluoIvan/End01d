(function(Endold, OptionBar) {
    ...
    var Reject_LIST_URL = '/page/page10/reject_list.php';
    var Swap_LIST_URL = '/page/page10/swap_list.php'; 
    var $searchForm = null;
        ...
        colModel: [ 
            {
               ...
               process: function(div, sn) {
                    div.innerHTML = div.innerHTML === 'csv' ? '到店取貨' : '宅配';
                }
            }, {
               display: '付款方式',
               name: 'methods', 
               ...
               align: 'center'
                ...
                process: function(div, sn) {
                    ...
                    var d_url = Endold.linkTo('page/page10/order_detail.php', {sn: sn});
