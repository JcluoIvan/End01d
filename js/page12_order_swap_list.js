(function(Endold, OptionBar) {
    ...
    var app = {
        ...
        onclickPrint: function() {
            ...
            $print.attr('action', Endold.linkTo('/page/page12/order_swap_list_print.php'));
        ...
        oncancelRadar: function() {
            ...
            if(confirm("確定是否取消換貨？")){
                Endold
                    .post(1223, {checkData:app.rows,date1:date1,date2:date2})
        ...
        oncheckRadar: function() {
            ...
            if(confirm("確定是否核帳？")){
                Endold
                    .post(1219, {checkData:app.rows,date1:date1,date2:date2})
                    .done(app.requestRadar);
            }
        },
    ...
    var grid = $('#order-list').flexigrid({
        ...
        colModel: [
                ...
                process: function(div, sn) {
                    ...
                    if(status=='-'){
                        ...
                        var $a = $('<a/>')
                            ...
                            .attr({href: Endold.linkTo('page/page12/order_swap_c.php', {sn: sn}) 
                            });
            ...
            //             .attr({href: Endold.linkTo('page/page12/order_swap_c.php', {oid: oid}) 
            //             });
            //             // .attr({
            //             //     'href': url,
            //             //     'oid': oid
