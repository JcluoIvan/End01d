(function(Endold, OptionBar) {
    ...
    var option = new OptionBar({
        ...
        onModify: function() {
            ...
            var url = 
                $this.attr('url') ||
                '/page/page01/organize_member_modify.php';

            app.cmd = $this.attr('cmd') || 105;
        ...
        colModel: [
            {
               ...
               align: 'center', 
                ...
                process: function(div, id) {
                    var $div = $(div);
                    $div.html('');
                    var url = 'page/page01/order_record.php';
                ...
                process: function(div, id) {
                    ...
                    $('<a/>')
                        .attr({
                            href: '#',
                            cmd: 122,
                            url: '/page/page01/blacklist_modify.php',
                            id: id,
                            is_black: is_black
                        })
                        .addClass(className)
