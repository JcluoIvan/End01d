(function(Endold, OptionBar) {
    ...
    var app = {
        ...
        disabled: function() {
            ...
            Endold.post(1109, {id: $id, is_disabled: $is_disabled})
                .done(app.gridReload);
        ...
        changePublicState: function() {
            ...
            Endold.post(1110, {id: id, is_public: is_public ? 0 : 1})
                .done(app.gridReload);
            event && event.preventDefault();
        },
        changeLockedState: function() {
            ...
            Endold.post(1150, {id: id, is_locked: is_locked ? 0 : 1})
                .done(app.gridReload);
            event && event.preventDefault();
        }
    };
    ...
    var modify = {
        init: function() {
            ...
            $modify.form.attr('action', Endold.cmdTo(1112));
    ...
    var option = new OptionBar({
        ...
        onModify: function() {
            ...
            return Endold.linkTo(
                '/page/page11/organize_modify.php', 
                {
                    pid: $pid, 
                    id: id
                }
