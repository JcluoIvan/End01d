(function(Endold, OptionBar) {
    ...
    var MODIFY_URL = '/page/page08/order_reject_c.php';
    ...
    var app = {
        ...
        onclickPrint: function() {
            ...
            var date1 = $('#date1').val();
            var date2 = $('#date2').val();
            var url = Endold.linkTo('/page/page08/reject_list_print.php', {
                oid: oid,
                no: no,
                date1: date1,
                date2: date2
                ...
                process: function(div, sn) {
                    ...
                    if(statusCheck=='核帳'){
                        ...
                        var $a = $('<a/>')
                            ...
                            .attr({href: Endold.linkTo('page/page08/order_reject_c.php', {sn: sn}) 
                            });
