(function(Endold) {
    ...
    var app = {
        ...
        requestSaveSuccess: function(response) {
            ...
            app.mainApp.reload();
            app.option.modify(Endold.linkTo(RETURN_MODIFY_URL, {id: response.id}));
        },
        onChangeProductItem: function() {
            var iid = app.$detail.item.val();
            var aid = app.$detail.parent.val();
            Endold.post(262, {iid: iid, aid: aid})
        ...
        updatePurchaseCount: function() {
            ...
            var value = prompt("更新商品退貨數量", $this.val());
